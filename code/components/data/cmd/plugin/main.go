...
func (p *provider) UserRepository() sdkrepo.UserRepository { return p.userRepo }

func (p *provider) GameRepository() sdkrepo.GameRepository { return p.gameRepo }

func (p *provider) MoveRepository() sdkrepo.MoveRepository { return p.moveRepo }

func (p *provider) UserCredentialsRepository() sdkrepo.UserCredentialsRepository { return p.credsRepo }
